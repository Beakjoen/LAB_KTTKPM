...
namespace StudentManagement
{
    ...
    public class StudentUI
    {
        ...
        public async Task RunAsync()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("=== QUẢN LÝ SINH VIÊN (SQL Server + Dapper) ===");
        ...
        /// <summary>Sửa theo Id số nguyên.</summary>
        private async Task UpdateStudentAsync()
        {
            Console.WriteLine("\n--- SỬA SINH VIÊN ---");
            var id = ReadInt("Nhập ID sinh viên cần sửa");
        ...
        {
            Console.WriteLine("\n--- XÓA SINH VIÊN ---");
            var id = ReadInt("Nhập ID sinh viên cần xóa");
